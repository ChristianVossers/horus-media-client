...
# count = 0
# images = []
# for root, dirs, files in os.walk(os.path.abspath("C:/Horus/Horus Input en Data/Fov110_front_Rdam Volgnummers_2/")):
#     for file in files:
...
#     processMmSegmentation(img, labels_of_interest_mapillary, 'horus_media_examples/GeoAI/output/' + str(count) + '.png')
#     count += 1
